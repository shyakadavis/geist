...
export const input_variants = tv({
	base: 'h-full rounded-[inherit] bg-background-100 px-3 py-2 text-sm transition-[border-color,box-shadow] file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-gray-700 focus:outline-none disabled:cursor-not-allowed disabled:bg-background-200 disabled:text-gray-700 disabled:placeholder:text-accents-3',
	variants: {
		size: {
			sm: 'text-sm',
			md: '',
