...
const book_variants = tv({
	slots: {
		...
		textured:
			'pointer-events-none absolute inset-0 rotate-180 rounded-[var(--book-border-radius)] bg-cover bg-no-repeat opacity-30 mix-blend-hard-light brightness-110 bg-book-textured',
		pages:
